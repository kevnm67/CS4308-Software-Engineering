...
//#if HAS_POD(Sidecar)
    CRLMethodLogFormatter *logFormatter = CRLMethodLogFormatter.new;
...
//#endif
    ...
    [[DDTTYLogger sharedInstance] setForegroundColor:[KJMColors flatBlue] backgroundColor:nil forFlag:DDLogFlagInfo];
    [[DDTTYLogger sharedInstance] setForegroundColor:[KJMColors greenNephritis] backgroundColor:nil forFlag:DDLogFlagDebug];
#endif
}
